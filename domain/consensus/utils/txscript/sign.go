...
// SignatureScript creates an input signature script for tx to spend SERA sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend SERA sent
